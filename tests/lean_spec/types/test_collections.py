...
# Define explicit Vector types for testing
...
# Additional Vector classes for tests
class Uint8Vector32(Vector):
    """A vector of exactly 32 Uint8 values."""
    ELEMENT_TYPE = Uint8
    LENGTH = 32


class Uint16Vector32(Vector):
    """A vector of exactly 32 Uint16 values."""
    ELEMENT_TYPE = Uint16
    LENGTH = 32


class Uint8Vector64(Vector):
    """A vector of exactly 64 Uint8 values."""
    ELEMENT_TYPE = Uint8
    LENGTH = 64


class Uint8Vector2(Vector):
...
class TestVector:
    ...
    def test_class_getitem_creates_specialized_type(self) -> None:
        """Tests that explicit Vector classes have the correct parameters."""
        vec_type_a = Uint8Vector32
        vec_type_b = Uint16Vector32
        assert vec_type_a is not Uint8Vector64
...
class TestList:
    ...
    def test_class_getitem_creates_specialized_type(self) -> None:
        ...
        assert list_type_a is not Uint8List64
